          ...
          <div className='contacto-horario'>
              ...
              <div className='contacto-dias-container'>
                  <div className='contacto-dias'>
                    ...
                    <p className='contacto-dias-hora'>10:00 a 17:00 hrs.</p>
                  </div>
                  <div className='contacto-dias'>
                    <p className='contacto-dias-texto'>Sábados y feriados</p>
                    <p className='contacto-dias-hora'>9:30 a 13:00 hrs.</p>
                  </div>
              </div>
          </div>
        </div>
        <div className='contacto-right-box'>
            <div className='contacto-checks'>
                ...
                <Link
                  ...
                  target={'_blank'}>
                  <FontAwesomeIcon icon={brands('whatsapp')} className='contacto-btn-icon'/>
                  Hablar
                </Link>
                  </div>
                <Link
                  ...
                  target={'_blank'}>
                  <FontAwesomeIcon icon={brands('facebook-f')} className='contacto-btn-icon'/>
                  Facebook
                </Link>
                <Link
                  ...
                  target={'_blank'}>
                  <FontAwesomeIcon icon={brands('instagram')} className='contacto-btn-icon'/>
                  Instagram
                </Link>
                <Link
                  ...
                  target={'_blank'}>
                  <FontAwesomeIcon icon={brands('twitter')} className='contacto-btn-icon'/>
                  Twitter
                </Link>
                <Link
                  ...
                  target={'_blank'}>
                  <FontAwesomeIcon icon={brands('tiktok')} className='contacto-btn-icon'/>
                  TikTok
                </Link>
            </div>
        </div>
